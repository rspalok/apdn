					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="col-xs-12 col-sm-12">
								<div class="">
									<h3 class="header smaller lighter blue">Student Details</h3>



									<sf:form method="post" modelAttribute="studentAdmission"
										...
										<div class="col-md-4">
											<div class="widget-body">
												<div class="widget-main">
													...
													<div>
														<label for="form-field-select-3">Batch</label> <br />
														<sf:select class="chosen-select form-control"
															id="form-field-select-3"
															data-placeholder="Choose a Batch..."
															path="studentBatch.id" disabled="true">
										...
										<div class="col-md-4">
											<div class="widget-body">
												<div class="widget-main">
													...
													<div>
														<label for="form-field-select-3">Course</label> <br />
														<sf:select class="chosen-select form-control"
															id="form-field-select-3_"
															data-placeholder="Choose a Course..."
															path="pistCourseMst.numCourseId" disabled="true">
															<sf:option value="0">Select</sf:option>
										...
										<div class="col-md-4">
											<div class="widget-body">
												<div class="widget-main">
													...
													<div>
														<label for="form-field-select-3">Specialization</label> <br />

														<sf:select class="chosen-select form-control"
															id="form-field-select-3"
															data-placeholder="Choose a Specialization..."
															path="courseSpecializationMaster.specId" disabled="true">

															<sf:option value="0">Select</sf:option>
															<c:forEach var="spec" items="${spec_list}">
																<sf:option value="${spec.specId}">${spec.specName}</sf:option>
															</c:forEach>
						...
						<div class="col-md-offset-9 col-md-3">
							<a href="register_student" class="btn btn-sm btn-success"> <i
								class="ace-icon fa fa-user bigger-200"></i> Register New Student
								<span class="label label-danger arrowed">click here</span>
							</a>
							...
							<div class="col-xs-12">
								...
								<div>
									<table id="dynamic-table"
										...
										<tbody>
											<c:forEach var="student" items="${student_lists }">
												<tr>
													<td><a href="#">${student.studentID.fullName }</a></td>

													<td><a href="#">${student.fileNo }</a></td>
													<td>${student.rollNo }</td>
													<td class="hidden-480">${student.studentID.dtBirthDate }</td>
													<td>${student.studentID.genderCode.gstrGenderName }</td>
													...
													<td>
														<div class="hidden-sm hidden-xs action-buttons">
															...
															<a class="red" href="delete/${student.studentID.id}">
																<i class="ace-icon fa fa-trash-o bigger-130"></i>
															</a>
															<%-- <%-- <spring:url value="${student.studentID.id}/delete" var="deleteUrl" /> 
															<input type="text" value="${ student.studentID.id}" id="my_id"/>
															
															<button class="btn btn-danger" onclick="chg()">Delete</button> --%>
															...
															<div class="hidden-md hidden-lg">
																...
																<ul
																	...
																	<li><a href="delete/${student.studentID.id }"
										...
										<div class="modal-body no-padding">
											<table
												...
												<tbody>
													...
													<tr>
														<td><a href="#">aRPIT sTPIYSDFSDF</a></td>
														<td>$55</td>
														<td>4,250</td>
														<td>Jan 21</td>
													</tr>
...
<![endif]-->
	...
	<script src="/MGIMS_SMS/assets/js/jquery.dataTables.min.js"></script>
	<script src="/MGIMS_SMS/assets/js/jquery.dataTables.bootstrap.min.js"></script>
	<script src="/MGIMS_SMS/assets/js/dataTables.buttons.min.js"></script>
	<script src="/MGIMS_SMS/assets/js/buttons.flash.min.js"></script>
	<script src="/MGIMS_SMS/assets/js/buttons.html5.min.js"></script>
	<script src="/MGIMS_SMS/assets/js/buttons.print.min.js"></script>
	<script src="/MGIMS_SMS/assets/js/buttons.colVis.min.js"></script>
	<script src="/MGIMS_SMS/assets/js/dataTables.select.min.js"></script>
...
/* 	function post(path, params, method) {
	...
	form.submit();
		 ...
		 function chg()
			{
				var val = document.getElementById('my_id').value;
					...
					if(xhttp.readystate===4 && http.status===200)
						{
							 ...
							 document.getElementById('my_id').innerHTML=xhttp.responseText; 
							$('#form-field-select-3__').html(xhttp.responseText); 
						}
				};
				
				xhttp.open("POST","delete?valajax="+val,true);
				xhttp.send();
			} 												
	</script>
</body>

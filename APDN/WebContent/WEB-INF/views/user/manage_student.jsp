...
<script type="text/javascript"
	src="<spring:url value="/assets/jquery/1.6/jquery-1.6.1.min.js" />"></script>
<script type="text/javascript"
	src="<spring:url value="/assets/jquery-ui/jquery-ui-1.8.10.custom.min.js" />"></script>	
...
<spring:url var="findStateCitiesURL" value="/user/cities" />
							...
							<div class="col-xs-12 col-sm-12">
								<div class="widget-box">
									<div class="widget-header">
										<h4 class="widget-title">Select Your Choice</h4>
									...
									<sf:form method="post" modelAttribute="studentAdmission">
												...
												<div class="widget-main">
													...
													<div>
														...
														<sf:select class="chosen-select form-control"
															...
															path="pistCourseMst.numCourseId"
										...
										<center>
											<button class="btn btn-success btn-next" data-last="Finish" disabled="disabled">

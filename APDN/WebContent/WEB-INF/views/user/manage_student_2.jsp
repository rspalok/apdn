						...
						<div class="col-xs-12">
							...
							<div class="col-xs-12 col-sm-12">
								<div class="widget-box">
									...
									<sf:form method="post" modelAttribute="studentAdmission" action="list_students">
												...
												<div class="widget-main">
													...
													<div>
														...
														<sf:select class="chosen-select form-control"
															...
															path="pistCourseMst.numCourseId" onchange="this.form.submit()">
															<sf:option value="0">Select</sf:option>
												...
												<div class="widget-main">
													...
													<div>
														...
														<sf:select class="chosen-select form-control"
															...
															path="courseSpecializationMaster.specId">
...
<![endif]-->
	...
	/* 	$(document).ready(function(){
			//$("#property_price").attr('data-placeholder', "Choose a Course...")
			$("#form-field-select-3_").on('change',function(){
				var courseId = $('#form-field-select-3_ option:selected').val();
				
				$.ajax({
					type: 'GET',
					url : 'user/manage_student/1',
